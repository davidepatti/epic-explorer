...
int User_interface::show_menu()
{
    ...
    cout << "\n\n   P e r f o r m   M a n u a l   S t e p s ";
    cout << "\n ---------------------------------------------------------------------";
    cout << "\n [1] - Compile processor hmdes file   [6] - View processor config";
    cout << "\n [2] - Compile benchmark              [7] - View cache config";
    cout << "\n [3] - Execute benchmark              [8] - Reload processor config";
    cout << "\n [4] - View execution statistics      [9] - Reload mem hierarchy file";
    cout << "\n [5] - Compute area/power/performance [0] - Save current config"; 
    cout << "\n ---------------------------------------------------------------------";
    cout << "\n [q] - Quit ";
    cout << "\n\n Make your choice:";
    char ch;
